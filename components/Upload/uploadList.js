...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "wave-upload-list" }, fileList.map(function (item) {
        return React.createElement("li", { className: "wave-upload-list-item", key: item.uid },
